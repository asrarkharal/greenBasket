...
$product = $product2DbHandler->fetchProductById($productId);
                ...
                <div class="product__details__pic">
                    <div class="product__details__pic__item">
                        <img class="product__details__pic__item--large"
                            src="img/product/<?= htmlentities($product['img_url']) ?>" alt="">
                    </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="product__details__text">
                    ...
                    <form action="add-cart-item.php" method="POST" id="product_page_form">
                        ...
                        <a href="#" class="heart-icon ml-3"><span class="icon_heart_alt"></span></a>
