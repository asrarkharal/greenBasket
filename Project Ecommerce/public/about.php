                ...
                <div class="col-lg-9">
                    <div class="hero__search">
                      ...
                      <div class="container">
                        ...
                        <h4 style="text-align:center; color:#7FAD39;  font-weight: bold;">OUR GOAL?</h4>
                        ...
                        <h4 style="text-align:center; color:#7FAD39;  font-weight: bold;">THREE PROMISES</h4>
                     
                        <p>-We always strive to be better and more durable on all fronts. We're not there yet, but we're working on it.</br>
                        -We promise to listen to you. If you have ideas or suggestions on how we can move forward, raise your hand, and we promise to answer.</br>
                        -Our long-term goal is to eradicate food waste and waste overall. You can dream! Then we sometimes have to sell goods with passed best-before dates. But never goods that are bad or inedible. We promise.
                    </div>
                </div>
            </div>
